...
# __GLX_VENDOR_LIBRARY_NAME=nvidia Besiege 

SCRIPT_DIR="$(dirname "$(realpath "$0")")"
export LD_PRELOAD="${SCRIPT_DIR}/libdoorstop.so"
echo "LD_PRELOAD ${LD_PRELOAD}"

executable_name="Besiege.x86_64"
...
# dll_search_path_override="/home/rhythmo/桌面/Besiege/Besiege/Besiege_Data/Mono/x86_64"
dll_search_path_override="$SCRIPT_DIR/Besiege_Data/Mono/x86_64"
