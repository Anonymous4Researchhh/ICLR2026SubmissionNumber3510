...
Paper: [Agentic Design of Compositional Machines](https://openreview.net/pdf?id=MOZCNzQPrF)
...
📥 BesiegeField Plugin is in `Plugin` folder.
...
#### Step 1: Run Cold Start with [Orthogonal Finetuning](https://huggingface.co/docs/peft/main/en/conceptual_guides/oft) (Dataset need to download from huggingface - update the dataset path in `cold_start.py` if needed)
